...
function Board() {
  ...
  const fetchPosts = useCallback(async () => {
    try {
      const res = await axios.get('https://campus-sync-production.up.railway.app/api/posts', {
  ...
  const fetchMyPosts = useCallback(async () => {
    try {
      const res = await axios.get('https://campus-sync-production.up.railway.app/api/posts/myposts', {
        headers: { Authorization: token }
      });
  ...
  const handleCreate = async () => {
    ...
    setFormError('');
    try {
      await axios.post('https://campus-sync-production.up.railway.app/api/posts', {
        ...form,
  ...
  const handleApply = async (id) => {
    try {
      await axios.post('https://campus-sync-production.up.railway.app/api/posts/' + id + '/apply', {}, { headers: { Authorization: token } });
      fetchPosts();
  ...
  const handleApplicantStatus = async (postId, userId, status) => {
    try {
      await axios.put('https://campus-sync-production.up.railway.app/api/posts/' + postId + '/applicants/' + userId, { status }, { headers: { Authorization: token } });
      fetchMyPosts();
    } catch (err) { console.log(err); }
  };
  ...
  const handleClose = async (id) => {
    try {
      await axios.put('https://campus-sync-production.up.railway.app/api/posts/' + id + '/close', {}, { headers: { Authorization: token } });
      fetchMyPosts();
      fetchPosts();
    } catch (err) { console.log(err); }
  };
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete('https://campus-sync-production.up.railway.app/api/posts/' + confirmDeleteId, { headers: { Authorization: token } });
  ...
  const handleEdit = async (id) => {
    try {
      await axios.put('https://campus-sync-production.up.railway.app/api/posts/' + id, { ...editPost, skillsRequired: editPost.skillsRequired }, { headers: { Authorization: token } });
      setEditPost(null);
      fetchMyPosts();
      fetchPosts();
    } catch (err) { console.log(err); }
