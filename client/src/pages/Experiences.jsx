...
function Experiences() {
  ...
  const fetchExperiences = useCallback(async (company = '') => {
    try {
      const res = await axios.get(`https://campus-sync-production.up.railway.app/api/experiences?company=${company}`, {
  ...
  const fetchMyExperiences = useCallback(async () => {
    try {
      const res = await axios.get('https://campus-sync-production.up.railway.app/api/experiences/mine', {
        headers: { Authorization: token }
      });
  ...
  const handlePost = async () => {
    ...
    setErrorMsg('');
    try {
      await axios.post('https://campus-sync-production.up.railway.app/api/experiences', form, {
        headers: { Authorization: token }
      });
  ...
  const handleUpvote = async (id) => {
    try {
      await axios.put(`https://campus-sync-production.up.railway.app/api/experiences/${id}/upvote`, {}, {
        headers: { Authorization: token }
      });
      fetchExperiences(search);
      fetchMyExperiences();
  ...
  const handleEdit = async (id) => {
    try {
      await axios.put(`https://campus-sync-production.up.railway.app/api/experiences/${id}`, editExp, {
        headers: { Authorization: token }
      });
      setEditExp(null);
      fetchExperiences(search);
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`https://campus-sync-production.up.railway.app/api/experiences/${confirmDeleteId}`, {
        headers: { Authorization: token }
      });
